<template>
  <div class="simple-war-view">
    ...
    <md-toolbar>
      <div v-if="!isAuthenticated">
        ...
        <md-dialog :md-active.sync="showLoginForm">
          ...
          <md-dialog-actions>
            ...
            <md-button class="md-primary" @click="validateAndSubmit"
              >Login</md-button
            >
          </md-dialog-actions>
        </md-dialog>
      ...
      <div v-if="isAuthenticated" class="md-title" style="flex: 1">
        {{ user.username }}
      </div>
      ...
      <div v-if="isAuthenticated">
        ...
        <md-button
          v-if="showGamesList || showMyProfile"
          @click="addNew"
          class="md-icon-button"
        >
          <md-icon>
          ...
          <md-tooltip>{{
            showGamesList ? "New 2-Player Game" : "Add Friend"
          }}</md-tooltip>
        </md-button>
        ...
        <md-menu md-direction="bottom-end">
          ...
          <md-menu-content>
            <md-menu-item v-if="!showGamesList" @click="goToGamesList"
              >My Games</md-menu-item
            >
            <md-menu-item
              v-if="!showMyProfile && !user.isGuest"
              @click="goToMyProfile"
              >My Profile</md-menu-item
            >
    ...
    <div v-if="isAuthenticated">
      ...
      <div v-if="showGamesList" class="md-layout md-gutter">
        <games-list-component
          v-if="
            games.length ||
              (!waiting.length && !pending.length && !completed.length)
          "
      ...
      <div v-if="showMyProfile" class="md-layout md-gutter">
        ...
        <md-dialog
          :md-active.sync="showAddFriends"
          @md-closed="friendUsernameSearch = ''"
        >
          ...
          <md-dialog-content>
            ...
            <div>
              <md-card
                v-for="(f, index) in friendSearchResults"
                :key="(f, index)"
              >
                <md-card-header>
                  <md-avatar>
        ...
        <md-dialog :md-active.sync="showAdvancedConfig">
          ...
          <md-dialog-content>
            ...
            <md-radio
              v-model="advancedGameConfigs.resetEnergyPerTurn"
              :value="true"
              >True</md-radio
            >
            <md-radio
          ...
          <md-dialog-actions>
            <md-button class="md-primary" @click="cancelAdvancedConfig"
              >Cancel</md-button
            >
            <md-button class="md-primary" @click="confirmAdvancedConfig"
              >Confirm</md-button
            >
          </md-dialog-actions>
        </md-dialog>
        ...
        (message: Stomp.Message) => {
          if (message.body) {
            ...
            if (!this.showGameBoard && this.selectedGameId !== msgObj.gameId) {
              ...
              this.$toast.info(
                `It is now your turn in Simple War against ${msgObj.username}!`
              );
            }
          }
        }
      ...
      this.friendRequestResponseSubscription = this.stompClient.subscribe(
        ...
        (message: Stomp.Message) => {
          ...
          if (message.body) {
            ...
            this.$toast.info(
              `${msgObj.username} ${msgObj.response} your friend request!`
            );
          }
        }
      );
