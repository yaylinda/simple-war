<template>
  ...
  >
    <md-card class="requests-list-card">
      ...
      <md-card-content
        class="outer-card-content md-layout md-alignment-top-center md-gutter"
      >
        <md-empty-state
        ...
        >
          <md-card class="one-request-card">
            <md-card-header>
              ...
              <div v-if="isIncoming" class="md-title">
                From: {{ r.requester }}
              </div>
              ...
              <div
                ...
                class="md-subtitle"
              >
                {{ r.requester }} wants to be your friend!
              </div>
              <div
                v-if="
                  isIncoming &&
                ...
                class="md-subtitle"
              >
                You {{ r.status }} {{ r.requester }}'s Friend Request
              </div>
              ...
              <div
                ...
                class="md-subtitle"
              >
                You want to be {{ r.requestee }}'s friend!
              </div>
              <div
                v-if="
                  !isIncoming &&
                ...
                class="md-subtitle"
              >
                {{ r.requestee }} {{ r.status }} your Friend Request
              </div>
            </md-card-header>
