<template>
  <div @click="cardClicked">
    <md-badge
      v-if="this.card.owner === this.username"
      class="md-square md-primary"
      :md-content="card.might"
    >
      <md-avatar :class="[determineClass(), isSmall ? 'md-small' : '']">
        <md-icon v-if="card.type === 'TROOP'">
          <i class="fa fa-users" :class="determineClass()"></i>
        </md-icon>
        <md-icon v-else-if="card.type === 'DEFENSE'">
          <i class="fa fa-shield" :class="determineClass()"></i>
        </md-icon>
        <md-icon v-else>
          <i class="fa fa-th" :class="determineClass()"></i>
        </md-icon>
        <md-tooltip md-direction="bottom">
          ...
          {{ card.cost }} |
          <i
            v-if="card.movementDirection === 'FORWARDS'"
            class="fa fa-arrow-up"
          ></i>
          <i
            v-if="card.movementDirection === 'RIGHT'"
            class="fa fa-arrow-right"
          ></i>
          <i
            v-if="card.movementDirection === 'LEFT'"
